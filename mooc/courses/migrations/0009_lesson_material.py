# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-04-23 17:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_date', models.DateField(blank=True, null=True, verbose_name='Data de publicação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Nome')),
                ('embedded', models.TextField(blank=True, verbose_name='Vídeo incorporado')),
                ('fileup', models.FileField(blank=True, upload_to='lessons/materials')),
